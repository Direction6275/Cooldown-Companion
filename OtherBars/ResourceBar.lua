...
local GetAnchorGroupFrame = RB.GetAnchorGroupFrame
...
local CreateDefaultLayoutOrder = RB.CreateDefaultLayoutOrder
...
local IsHealerSpec = RB.IsHealerSpec
...
local LayoutResourceAuraStackSegments = RB.LayoutResourceAuraStackSegments
