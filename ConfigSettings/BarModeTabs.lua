...
local function BuildBarAppearanceTab(container, group, style)
    ...
    SetupColorCallbacks(barColorPicker, style, "barColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    SetupColorCallbacks(barCdColorPicker, style, "barCooldownColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    SetupColorCallbacks(barChargeColorPicker, style, "barChargeColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    SetupColorCallbacks(barBgColorPicker, style, "barBgColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    SetupColorCallbacks(borderColor, style, "borderColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    if nameAdvExpanded and style.showBarNameText ~= false then
        ...
        SetupColorCallbacks(nameFontColor, style, "barNameFontColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    if timeAdvExpanded and style.showCooldownText then
        ...
        SetupColorCallbacks(cdFontColor, style, "cooldownFontColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    if chargeAdvExpanded and style.showChargeText ~= false then
        ...
        SetupColorCallbacks(chargeFontColor, style, "chargeFontColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
        ...
        SetupColorCallbacks(chargeFontColorMissing, style, "chargeFontColorMissing", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
        ...
        SetupColorCallbacks(chargeFontColorZero, style, "chargeFontColorZero", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    if barAuraTextAdvExpanded and style.showAuraText ~= false then
        ...
        SetupColorCallbacks(auraFontColor, style, "auraTextFontColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    if barAuraStackAdvExpanded and style.showAuraStackText ~= false then
        ...
        SetupColorCallbacks(asFontColor, style, "auraStackFontColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
    ...
    if readyAdvExpanded and style.showBarReadyText then
        ...
        SetupColorCallbacks(readyColorPicker, style, "barReadyTextColor", function() CooldownCompanion:UpdateGroupStyle(CS.selectedGroup) end)
