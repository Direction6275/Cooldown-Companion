...
local function ConfigureCastPreview(frame, slot, preview, width, height)
    ...
    if settings.showNameText == false then
        ...
        bar.nameText:SetFont(font, settings.nameFontSize or DEFAULT_RESOURCE_TEXT_SIZE, ST.GetEffectiveFontOutline(settings.nameFontOutline or DEFAULT_RESOURCE_TEXT_OUTLINE))
    ...
    if settings.showCastTimeText == false then
        ...
        bar.timeText:SetFont(font, settings.castTimeFontSize or DEFAULT_RESOURCE_TEXT_SIZE, ST.GetEffectiveFontOutline(settings.castTimeFontOutline or DEFAULT_RESOURCE_TEXT_OUTLINE))
