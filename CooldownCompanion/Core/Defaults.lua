...
local defaults = {
    ...
    profile = {
            ...
            --[[
                [groupId] = {
                    ...
                    style = {
                        ...
                        auraGlowStyle = "pulse", -- kit styles: none/solid/pulse/colorShift/dashes/autocast/ants/proc/overlay
        ...
        castBar = {
            ...
            showSpark = true,
            showSparkTrail = true,
            showChannelTickMarks = false,
            channelTickWidth = 1,
            channelTickColor = { 1, 1, 1, 0.8 },
            highlightPenultimateChannelTick = false,
            penultimateChannelTickColor = { 1, 0.82, 0, 1 },
