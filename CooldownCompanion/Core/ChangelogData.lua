...
- **While Aura Active section:** One place on the Appearance tab now controls what the aura display does to a button, with a clear Cooldown dropdown: Hidden by Aura, Show Text, or Show Swipe and Text. The text options keep the cooldown countdown and the charge count readable during the aura. Keeping the spell's cooldown swipe visible during the aura is back for the first time since 1.22, and old imports that used it recover the setting automatically.
