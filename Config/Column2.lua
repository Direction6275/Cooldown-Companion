...
local function RefreshColumn2()
    ...
    autoAddBtn:SetCallback("OnEnter", function(widget)
        ...
        GameTooltip:AddLine("Launches a streamlined 3-step import flow in the Button Settings column.", 1, 1, 1, true)
        GameTooltip:AddLine("Source selection, source options, then entry review and confirmation.", 1, 1, 1, true)
        GameTooltip:Show()
    end)
