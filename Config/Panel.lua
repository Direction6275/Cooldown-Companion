...
local function CreateConfigPanel()
    ...
    groupInfoBtn:SetScript("OnEnter", function(self)
        ...
        if CS.resourceBarPanelActive then
            ...
            GameTooltip:AddLine("Hold left-click and drag to reorder.", 1, 1, 1, true)
            GameTooltip:AddLine(" ")
            ...
            GameTooltip:AddLine("Left-click to expand/collapse.", 1, 1, 1, true)
    ...
    bsInfoBtn:SetScript("OnEnter", function(self)
        ...
        elseif CS.autoAddFlowActive then
            ...
            GameTooltip:AddLine("Select a button to configure that button.", 1, 1, 1, true)
            GameTooltip:AddLine("Select a panel header to configure that panel.", 1, 1, 1, true)
        end
        GameTooltip:Show()
    end)
    ...
    settingsInfoBtn:SetScript("OnEnter", function(self)
        ...
        if CS.resourceBarPanelActive then
            ...
            GameTooltip:AddLine("Select a button to configure its panel.", 1, 1, 1, true)
            GameTooltip:AddLine("Select a group or panel header to configure the group.", 1, 1, 1, true)
        end
        GameTooltip:Show()
    end)
