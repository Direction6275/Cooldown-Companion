...
ST.OVERRIDE_SECTIONS = {
    ...
    procGlow = {
        label = "Proc Glow",
        keys = {"procGlowStyle", "procGlowColor", "procGlowSize", "procGlowThickness", "procGlowSpeed", "procGlowCombatOnly"},
        modes = {icons = true},
    },
    pandemicGlow = {
        label = "Pandemic Glow",
        keys = {"showPandemicGlow", "pandemicGlowStyle", "pandemicGlowColor", "pandemicGlowSize", "pandemicGlowThickness", "pandemicGlowSpeed", "pandemicGlowCombatOnly"},
        modes = {icons = true},
    },
    auraIndicator = {
        label = "Show Aura Glow",
        keys = {"auraGlowStyle", "auraGlowColor", "auraGlowSize", "auraGlowThickness", "auraGlowSpeed", "auraGlowInvert", "auraGlowCombatOnly"},
        modes = {icons = true},
    },
    readyGlow = {
        label = "Ready Glow",
    ...
    pandemicBar = {
        ...
        keys = {"showPandemicGlow", "barPandemicColor", "pandemicBarEffect", "pandemicBarEffectColor", "pandemicBarEffectSize", "pandemicBarEffectThickness", "pandemicBarEffectSpeed", "pandemicGlowCombatOnly"},
        modes = {bars = true},
    },
    barActiveAura = {
        label = "Active Aura Indicator",
        keys = {"barAuraColor", "barAuraEffect", "barAuraEffectColor", "barAuraEffectSize", "barAuraEffectThickness", "barAuraEffectSpeed", "auraGlowCombatOnly"},
        modes = {bars = true},
    },
    barIcon = {
        label = "Bar Icon",
