            ...
            --[[
                [groupId] = {
                    ...
                    style = {
                        ...
                        auraGlowPulse = false,
                        auraGlowPulseSpeed = 0.5,
                        auraGlowPulseMinAlpha = 0.3,
                        auraGlowBorder = false,
                        auraGlowBorderColor = {1, 0.84, 0, 0.9},
                        auraGlowBorderSize = 2,
                        readyGlowStyle = "none",
                        ...
                        barAuraPulseMinAlpha = 0.3,
                        barAuraBorder = false,
                        barAuraBorderColor = {1, 0.84, 0, 0.9},
                        barAuraBorderSize = 2,
...
ST.OVERRIDE_SECTIONS = {
    ...
    auraIndicator = {
        ...
        keys = {"auraGlowStyle", "auraGlowColor", "auraGlowSize", "auraGlowThickness", "auraGlowSpeed", "auraGlowLines", "auraGlowInvert", "auraGlowCombatOnly", "auraGlowPulse", "auraGlowPulseSpeed", "auraGlowPulseMinAlpha", "auraGlowBorder", "auraGlowBorderColor", "auraGlowBorderSize"},
        modes = {icons = true},
    },
    readyGlow = {
        label = "Ready Glow",
    ...
    barActiveAura = {
        ...
        keys = {"barAuraColor", "barAuraEffect", "barAuraEffectColor", "barAuraEffectSize", "barAuraEffectThickness", "barAuraEffectSpeed", "barAuraEffectLines", "auraGlowCombatOnly", "barAuraPulse", "barAuraPulseSpeed", "barAuraPulseMinAlpha", "barAuraBorder", "barAuraBorderColor", "barAuraBorderSize"},
        modes = {bars = true},
    },
    barIcon = {
        label = "Bar Icon",
